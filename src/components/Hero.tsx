    ...
    <div className="mx-auto grid max-w-6xl gap-10 px-4 lg:grid-cols-2 lg:items-center">
      <div className="space-y-6">
        ...
        <p className="text-lg text-slate-200">
          Sharpen your proof skills, competition strategy, and university coursework with individualized guidance from a decorated
          international competitor and UCLA mathematics student. Sessions are easy to reserve through Koalendar with secure Stripe
          checkout built into the booking flow.
        </p>
      ...
      <div className="relative">
        <div className="card-surface h-full space-y-4">
          ...
          <p className="text-sm text-slate-300">
            “Every student can learn to think like a mathematician. I focus on the rigor, curiosity, and pattern-finding that earn
            points in competition and clarity in coursework.”
          </p>
