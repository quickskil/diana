    ...
    <section id="pricing" className="section">
      <div className="container space-y-10">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {tiers.map((t, i)=>(
            <motion.div key={t.name} className="card p-6 flex flex-col gap-4" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: i * 0.1 }} viewport={{ once: true }}>
              ...
              <a href={t.cta} className="btn mt-auto">Book a Call</a>
            </motion.div>
          ))}
        </div>
      </div>
