    ...
    <section className="section">
      <div className="mx-auto max-w-6xl space-y-8 px-4">
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
          <div className="card-surface space-y-4 bg-gradient-to-br from-white via-rose-50 to-pink-50">
            <p className="label">Schedule</p>
            <h1 className="text-4xl font-bold text-slate-900">Book a tutoring session with Diana</h1>
            ...
            <div className="grid grid-cols-1 gap-3 text-sm text-slate-700 sm:grid-cols-2">
              {[
                ...
                <div key={item} className="flex items-start gap-3 rounded-2xl border border-rose-100 bg-white/80 p-3 shadow-sm shadow-rose-100/70">
          ...
          <div className="card-surface space-y-4 bg-white/90">
            <p className="text-sm font-semibold text-rose-700">How booking works</p>
            <ol className="space-y-2 text-sm text-slate-700">
              {[
                ...
                <li key={item} className="flex gap-3">
                  <span className="flex h-7 w-7 items-center justify-center rounded-full bg-rose-100 text-sm font-bold text-rose-700">
                    {index + 1}
                  </span>
                  <span>{item}</span>
                </li>
            ...
            <div className="rounded-2xl border border-rose-100 bg-rose-50 p-4 text-sm text-slate-700">
              <p className="font-semibold text-rose-700">Prefer a call first?</p>
              <p>
        ...
        {bookingUrl ? (
          <div className="card-surface overflow-hidden border border-rose-100 bg-white/90 p-0">
            <iframe
              src={bookingUrl}
          ...
          <div className="card-surface space-y-3 bg-white">
            <p className="text-lg font-semibold text-rose-700">Add your Koalendar link</p>
            <p className="text-sm text-slate-700">
              Set the <code className="rounded bg-rose-50 px-2 py-1">NEXT_PUBLIC_KOALENDAR_URL</code> environment variable to your
              Koalendar booking page (for example, <span className="text-rose-500">https://koalendar.com/e/your-link</span>), then
        ...
        <div className="space-y-4">
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h2 className="text-3xl font-bold text-slate-900">Why families and students love booking with Diana</h2>
            </div>
            <Link href="/schedule" className="button-primary">
              Reserve your spot
            </Link>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {scheduleTestimonials.map((testimonial) => (
              <div key={testimonial.name} className="card-surface space-y-3 bg-white">
